            ...
            {/* Content */}
              <div className="relative z-10 flex flex-col items-center justify-center h-full text-center px-4">
                <h1 className="md:text-6xl mb-6">
                  <span className="font-bebas-neue text-8xl text-white px-4 bg-black bg-opacity-30 text-shadow">
                    BUILD THE BODY YOU'VE ALWAYS WANTED
                  </span>
                  <br />
                </h1>
                <p className="text-white font-medium text-lg text-center md:text-xl max-w-2xl mb-8 px-4 bg-black bg-opacity-40">
