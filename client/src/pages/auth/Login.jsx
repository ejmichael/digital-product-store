        ...
        <div className="m-auto flex-col shadow rounded-md lg:w-[30%] md:w-[50%] p-4 bg-white">
            ...
            <div className="flex justify-center">
                <form onSubmit={handleSubmit} className="my-4 min-w-[300px]">
                    <div className="my-2">
                        <input type="email" className="border rounded p-2 w-full" name="email" id='email' value={email} placeholder="Enter your email" onChange={handleChange}/>
                    </div>
                    <div className="my-2">
                        <input type="password" className="border rounded p-2 w-full" name="password" id='password' value={password} placeholder="Enter your password" onChange={handleChange}/>
                    </div>
